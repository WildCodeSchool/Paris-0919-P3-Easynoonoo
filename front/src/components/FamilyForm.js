    ...
    <div className="familyFormParent">
      ...
      <div className="familyForm">
        ...
        {answers1 > 1 ? (
          <div className="familyFormNumberInput">
            <label className="question2">
              Parmi ces enfants, combien sont à vous ?
            </label>{' '}
            <input
              type="number"
              classname="answers2"
        ...
        {answers1 === answers2 && answers1 > 1 ? (
          <div>
            <p className="question3">
              La garde de vos enfants est-elle partagée avec un autre
              parent ?
            </p>
            <div className="radio">
              <label>
        ...
        {answers1 == 1 ? (
          <div>
            <p className="question3">
              La garde de votre enfant est-elle partagée avec un autre
              parent ?
            </p>
            <div className="radio">
              <label>
