...
const FamilyForm = () => {
  ...
  const initialAnswer3 = () => false //so that it restarts for a new simulation without divorcee
  ...
  useEffect(() => {
    ...
    notMyChild,
    showCalendar,
  ]) //callback run if only the answers change
        ...
        <div className="zifamosoSimulateur container-fluid ">
          ...
          {totalEnfants > 1 && totalEnfants <= 4 ? (
            <div class="form-group">
              <label>
                Parmi ces {totalEnfants} enfants, combien sont de
                votre famille ?
              </label>
              <input
                class="form-control"
          ...
          {totalEnfants === 1 && gardeAlternee === 'true' ? (
            <div className=" question4">
              ...
              <div className="container-fluid arrayNameChildren ">
                <div className="row familyFormHeaderName">
                  Mon enfant
                </div>
                {myChild.map(e => (
          ...
          {nbEnfants < totalEnfants && nbEnfants !== 0 ? (
            <div className="question4">
              ...
              {myChild.length == nbEnfants &&
              totalEnfants - nbEnfants >= 1 ? (
                <div className="container-fluid arrayNameChildren">
                  <div className="row familyFormHeaderName">
                    Les enfants de la co-famille
                  </div>
                  {notMyChild.map(e => (
                    <div className="row blocName"> {e} </div>
                  ))}
...
export default withRouter(FamilyForm)
