        ...
        <div className="card-body">
          ...
          <div className="row">
            ...
            {this.example(
              'after',
              this.state.after &&
                moment(this.state.after, 'YYYY-MM-DD'),
              [{ after: moment().add(1, 'month') }],
              'date',
            )}
            {this.example(
              'after_or_equal',
              this.state.after_or_equal &&
                moment(this.state.after_or_equal, 'YYYY-MM-DD'),
            ...
            {this.example(
              'before',
              this.state.before &&
                moment(this.state.before, 'YYYY-MM-DD'),
              [{ before: moment().add(1, 'month') }],
              'date',
            )}
            {this.example(
              'before_or_equal',
              this.state.before_or_equal &&
                moment(this.state.before_or_equal, 'YYYY-MM-DD'),
            ...
            {this.example(
              'date_equals',
              this.state.date_equals &&
                moment(this.state.date_equals, 'YYYY-MM-DD'),
              [{ date_equals: moment() }],
              'date',
            )}
            {this.example('email')}
            ...
            {this.example('string')}
            {this.example('typeof', this.state.typeof, [
              { typeof: 'string' },
            ])}
            {this.example('url')}
          ...
          {this.validator.messageWhenPresent(this.state.ajaxError, {
            element: message => (
