      ...
      <div className="container card my-4">
        <div className="card-body">
          ...
          <div className="row">
            ...
            {this.example(
              "after",
              this.state.after && moment(this.state.after, "YYYY-MM-DD"),
            ...
            {this.example(
              "before",
              this.state.before && moment(this.state.before, "YYYY-MM-DD"),
            ...
            {this.example(
              "date",
              this.state.date && moment(this.state.date, "YYYY-MM-DD"),
              "date",
              "date"
            )}
            {this.example(
